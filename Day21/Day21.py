...
def springscriptRun(instructionList):
    """
    Calculate holes and jump over them.
    :return:
    """
    ...
    #part 2
    input = "NOT A T\n NOT C J\n OR T J\n NOT B T\n OR T J\n AND D J\n NOT H T\n NOT T T\n OR E T\n AND T J\n RUN\n"
    instructions = ([ord(character) for character in input] )

    incodeProgram.inputValues += instructions
...
if __name__ == "__main__":
    ...
    holesValue = springscriptRun(instructionList)
    print(f"springscriptRun: {holesValue}")
